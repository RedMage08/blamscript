...
(global long default_turret_delay
	(* 30.00 10.00))

(global long control_turret_delay
	(* 30.00 10.00))

(global short exterior_player_location 0)

(global bool mission_start false)

(global bool a1_spawn true)

(global short a1_spawn_counter 0)

(global short a1_squad_index 1)

(global bool a_bridge_rein true)

(global short a_bridge_rein_counter 0)

(global short a_bridge_rein_index 1)

(global bool ext_a_spawn true)

(global short ext_a_spawn_counter 0)

(global short ext_a_squad_index 1)

(global bool crev_ent_turrets true)

(global short crev_ent_turret_counter 0)

(global short crev_ent_turret_limit 3)

(global bool b3_top_spawn true)

(global short b3_top_spawn_counter 0)

(global short b3_top_squad_index 2)

(global bool b4_bridge_spawn true)

(global short b4_bridge_spawn_counter 0)

(global short b4_bridge_squad_index 1)

(global bool c_bridge_spawn true)

(global short c_bridge_spawn_counter 0)

(global short c_bridge_squad_index 2)

(global bool play_music_b40_01 true)

(global bool play_music_b40_011 true)

(global bool play_music_b40_02 true)

(global bool play_music_b40_03 true)

(global bool play_music_b40_04 true)

(global bool play_music_b40_041 true)

(global bool play_music_b40_042 true)

(global bool play_music_b40_05 true)

(global bool play_music_b40_06 true)

(global bool play_music_b40_061 true)

(global bool play_music_b40_07 true)

(global bool play_music_b40_071 true)

(global bool play_music_b40_08 true)

(global bool ext_a_mig_cov true)
...
(script static void cutscene_insertion_a
	(begin
		(sound_looping_start sound\sinomatixx_foley\b40_insertion_foley none 1.00)
		(sound_class_set_gain vehicle 0.30 0)
		(objects_predict insertion_pelican)
		(objects_predict awake_1)
		(object_beautify awake_1 true)
		(fade_out 0.00 0.00 0.00 0)
		(switch_bsp 3)
		(object_teleport cutscene_insertion_a player0_insertion_safe)
		(object_teleport cutscene_insertion_a player1_insertion_safe)
		(cinematic_start)
		(show_hud false)
		(camera_control true)
...
(script static void cutscene_insertion_b
	(begin
		...
		(unit_exit_vehicle cutscene_insertion_b)
		(unit_exit_vehicle cutscene_insertion_b)
		(cinematic_stop)
		(show_hud true)
		(sleep 60)
...
(script static void cutscene_extraction
	(begin
		...
		(camera_control true)
		(switch_bsp 2)
		(object_teleport cutscene_extraction player0_extraction_safe)
		(object_teleport cutscene_extraction player1_extraction_safe)
		...
		(sleep 180)
		(sound_impulse_start sound\dialog\b40\b40_extract_010_cortana none 1.00)
		(print cortana: this is it. halo's control center.)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_010_cortana))
		...
		(sleep
			(-
				(recording_time chief) 15.00))
		(camera_set plugin_1a 0)
		(camera_set plugin_1b 200)
		(sound_looping_start sound\sinomatixx_foley\b40_extraction_foley none 1.00)
		(custom_animation chief cinematics\animations\chief\level_specific\b40\b40 b40-clip01-thisisit true)
		(sleep 60)
		(sound_impulse_start sound\dialog\b40\b40_extract_020_cortana none 1.00)
		...
		(object_set_scale cortana 7.00 60)
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_030_chief chief 1.00)
		(print chief: you alright?)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_030_chief))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_040_cortana cortana 1.00)
		(print cortana: never been better.)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_040_cortana))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_050_cortana cortana 1.00)
		(print cortana: you can't imagine the wealth of information--the knowledge! so much! so fast! it's glorious!)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_050_cortana))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_060_chief chief 1.00)
		(print chief: so, what sort of weapon is it?)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_060_chief))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_070_cortana cortana 1.00)
		(print cortana: what are you talking about?)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_070_cortana))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_080_chief chief 1.00)
		(print chief: let's stay focused. halo. how do we use it against the covenant?)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_080_chief))
		(unit_stop_custom_animation chief)
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_090_cortana cortana 1.00)
		(print cortana: this ring isn't a cudgel, you barbarian. it's something else...something much more important. )
		(sleep
			(-
				(sound_impulse_time sound\dialog\b40\b40_extract_090_cortana) 120.00))
		(unit_set_emotion cortana 6)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_090_cortana))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_100_cortana cortana 1.00)
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_120_chief chief 1.00)
		(print chief: slow down. you're losing me.)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_120_chief))
		(camera_set cortana_cu_2a 0)
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_130_cortana cortana 1.00)
		(print cortana: the covenant found something. buried in this ring. something horrible. and now...they're afraid.)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_130_cortana))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_140_chief chief 1.00)
		(print chief: something buried? where?)
		(sleep
			(-
				(sound_impulse_time sound\dialog\b40\b40_extract_140_chief) 15.00))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_150_cortana cortana 1.00)
		(print cortana: the captain! we've got to stop the captain!)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_150_cortana))
		(camera_set chief_captain_1a 0)
		(camera_set chief_captain_1b 30)
		(object_set_scale cortana 7.00 0)
		(unit_stop_custom_animation chief)
		(custom_animation chief cinematics\animations\chief\level_specific\b40\b40 b40-clip07-keys true)
		(sound_impulse_start sound\dialog\b40\b40_extract_160_chief chief 1.00)
		(print chief: keyes? what--)
		(sleep
			(-
				(sound_impulse_time sound\dialog\b40\b40_extract_160_chief) 15.00))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_170_cortana cortana 1.00)
		(print cortana: the weapons cache he's looking for, it's not really--we can't let him get inside!)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_170_cortana))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_180_chief chief 1.00)
		(print chief: i don't--)
		(sleep
			(-
				(sound_impulse_time sound\dialog\b40\b40_extract_180_chief) 15.00))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_190_cortana cortana 1.00)
		...
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_extract_190_cortana))
		...
		(sound_impulse_start sound\dialog\b40\b40_extract_200_cortana cortana 1.00)
...
(script continuous void cont_crev_save
	(begin
		(sleep_until
			(volume_test_objects crevasse_trigger
				(players)))
		(wake general_save)
		(sleep
			(* 30.00 60.00))))
...
(script dormant void save_script
	(begin
		(sleep_until
			(volume_test_objects a_bridge_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects a2_top_a_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects a2_top_b_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects a2_bottom_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects ext_a_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects crev_a_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects crev_b_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects b3_bottom_a_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects b3_bottom_b_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects b3_bridge_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects b5_a_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects c_bridge_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects c1_top_a_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects c1_top_b_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects c1_bottom_save
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects ext_c_save
				(players)))
		(wake general_save)))
...
(script dormant void music_b40_01
	(begin
		(sleep_until
			(>
				(ai_conversation_status a_bridge_marines) 3))
		(sound_looping_start levels\b40\music\b40_01 none 1.00)))

(script dormant void music_b40_011
	(begin
		(sleep_until
			(>
				(device_get_position a2_top_ent_door) 0.00))
		(sound_looping_start levels\b40\music\b40_011 none 1.00)
		(sleep_until
			(or
				(volume_test_objects a2_top_b_save
					(players))
...
(script dormant void music_b40_02
	(begin
		(sleep_until
			(=
				(device_get_position lift_a) 1.00))
		(sound_looping_start levels\b40\music\b40_02 none 1.00)
		(sleep_until
			(>
				(device_get_position ext_a_door) 0.00))
...
(script dormant void music_b40_03
	(begin
		(sleep_until
			(or
				(volume_test_objects ext_a_area_c_trigger_a
					(players))
				(volume_test_objects ext_a_area_c_trigger_b
					(players))
				(vehicle_test_seat_list ext_a_tank scorpion-driver
					(players))))
		(sound_looping_start levels\b40\music\b40_03 none 1.00)
		(sleep_until
			(or
				(<=
					(unit_get_health crev_ent_wraith_a) 0.00)
				(<=
					(unit_get_health crev_ent_wraith_b) 0.00)
				(volume_test_objects ext_a_c_door
					(players))))
...
(script dormant void music_b40_04
	(begin
		(sleep_until
			(>
				(device_get_position garagedoor_a) 0.00))
		(sound_looping_start levels\b40\music\b40_04 none 1.00)
		(sleep_until
			(not play_music_b40_04))
		(sound_looping_stop levels\b40\music\b40_04)))

(script dormant void music_b40_041
	(begin
		(sound_looping_start levels\b40\music\b40_041 none 1.00)
		(sleep_until
			(not play_music_b40_041))
...
(script dormant void music_b40_042
	(begin
		(sleep_until
			(>
				(device_get_position b3_bot_ent_door) 0.00))
		(sound_looping_start levels\b40\music\b40_042 none 1.00)
		(sleep_until
			(>
				(device_get_position lift_c) 0.00))
...
(script dormant void music_b40_05
	(begin
		(sleep_until
			(=
				(ai_status b3_top_cov/elite_commander) 6))
		(sound_looping_start levels\b40\music\b40_05 none 1.00)
		(sleep_until
			(not play_music_b40_05))
...
(script dormant void music_b40_06
	(begin
		(sleep_until
			(>
				(device_get_position b4_bridge_door) 0.00))
		(sound_looping_start levels\b40\music\b40_06 none 1.00)
		(sleep_until
			(volume_test_objects b4_bridge_reins_trigger_b
				(players)))
		(sleep 30)
		(sleep_until
			(or
...
(script dormant void music_b40_061
	(begin
		(sleep_until
			(or
				(volume_test_objects b5_hall_trigger
					(players))
				(=
					(ai_living_count b5_a_cov) 0)))
		(sound_looping_start levels\b40\music\b40_061 none 1.00)
		(sleep_until
			(volume_test_objects b5_b_trigger
				(players)))
		(sleep 30)
		(sleep_until
			(or
...
(script dormant void music_b40_07
	(begin
		(sleep_until
			(=
				(device_get_position c_bridge_near_door) 1.00))
		(ai_conversation view_zig)
		(sleep_until
			(>
				(ai_conversation_status view_zig) 4))
		(sound_looping_start levels\b40\music\b40_07 none 1.00)
		(sleep_until
			(not play_music_b40_07) 30
			(* 30.00 89.00))
...
(script dormant void music_b40_071
	(begin
		(sleep_until
			(>
				(device_get_position c1_top_ent_door) 0.00))
		(sound_looping_start levels\b40\music\b40_071 none 1.00)
		(sleep_until
			(or
				(>
					(device_get_position ext_c_ent_door) 0.00)
...
(script dormant void music_b40_08
	(begin
		...
		(sound_looping_start levels\b40\music\b40_08 none 1.00)
		(sleep_until
			(not play_music_b40_08))
...
(script dormant void dialog_ext_a_a_clear
	(begin
		(sleep_until
			(=
				(ai_living_count ext_a_area_a_cov) 0))
		(if
			(=
				(volume_test_objects ext_a_area_b_trigger
					(players)) false)
...
(script dormant void dialog_ext_a_b
	(begin
		(sleep_until
			(=
				(ai_living_count ext_a_area_b_cov) 0))
...
(script dormant void dialog_ext_a_c
	(begin
		(sleep_until
			(volume_test_objects ext_a_c_dialog
				(players)))
...
(script dormant void dialog_scorpion_dead
	(begin
		(sleep_until
			(<=
				(unit_get_health ext_a_tank) 0.00))
...
(script dormant void dialog_ext_b_c_clear
	(begin
		...
		(sleep_until
			(=
				(ai_living_count ext_b_area_c_cov) 0))
		(if
			(>
				(ai_living_count ext_b_marines) 0)
	...
	(begin
		(sleep_until
			(objects_can_see_object
				(players) ext_c_banshee_a 30.00))
		(sleep 30)
		(ai_conversation c_bridge_banshee)
		(sleep_until
			(and
				(vehicle_test_seat_list ext_c_banshee_a b-driver
					(ai_actors ext_c_banshee/banshee))
				(vehicle_test_seat_list ext_c_banshee_b b-driver
					(ai_actors ext_c_banshee/banshee))))
		(sleep 30)
...
(script dormant void game_win_script
	(begin
		(sleep_until
			(>
				(device_get_position control_door_d) 0.00))
		(sleep -1 dialog_control_clear)
		(ai_conversation_stop control_clear)
		(sleep_until
			(>
				(device_get_position control_door_d) 0.30))
...
(script dormant void help_banshee
	(begin
		(sleep_until
			(or
				(vehicle_test_seat_list insertion_banshee_a b-driver
					(players))
				(vehicle_test_seat_list ext_c_banshee_a b-driver
					(players))
				(vehicle_test_seat_list ext_c_banshee_b b-driver
...
(script dormant void title_thunder
	(begin
		(sleep_until
			(volume_test_objects ext_b_trigger
				(players)) 5)
...
(script dormant void title_control
	(begin
		(sleep_until
			(volume_test_objects ext_c_trigger_a
				(players)))
		(cinematic_show_letterbox true)
		(show_hud false)
		(sleep 30)
...
(script static void ext_b_b_dropship_a
	(begin
		...
		(vehicle_load_magic c_dropship_b passenger
			(ai_actors ext_b_area_b_cov/elites_p))
		(vehicle_load_magic c_dropship_b passenger
			(ai_actors ext_b_area_b_cov/grunts_p))
		(vehicle_load_magic c_dropship_b passenger
			(ai_actors ext_b_area_b_cov/jackals_p))
		(sleep 1)
		(objects_predict c_dropship_b)
		(objects_predict
			(ai_actors ext_b_area_a_cov))
		(sleep 150)
		(ai_conversation ext_b_b_reins)
		(sleep
			(recording_time c_dropship_b))
...
(script static void ext_b_a_dropship_a
	(begin
		...
		(vehicle_load_magic c_dropship_b passengerl
			(ai_actors ext_b_area_a_cov/grunts_e))
		(vehicle_load_magic c_dropship_b passengerl
			(ai_actors ext_b_area_a_cov/jackals_e))
		(vehicle_load_magic c_dropship_b passengerr
			(ai_actors ext_b_area_a_cov/elites_f))
		(vehicle_load_magic c_dropship_b passengerr
			(ai_actors ext_b_area_a_cov/grunts_f))
		(vehicle_load_magic c_dropship_b passengerr
			(ai_actors ext_b_area_a_cov/jackals_f))
		(sleep 1)
		(objects_predict c_dropship_b)
		...
		(sleep
			(-
				(recording_time c_dropship_b) 60.00))
		(begin_random
			(begin
		...
		(ai_vehicle_enterable_distance ext_b_a_ghost_a 20.00)
		(ai_vehicle_enterable_distance ext_b_a_ghost_b 20.00)
...
(script static void cinematic_ext_a_pelican
	(begin
		...
		(sleep 60)
		(ai_disregard
			(ai_actors ext_a_area_a_marines/marines_pelican) true)
		...
		(sleep_until
			(=
				(ai_command_list_status
					(ai_actors ext_a_area_a_marines)) 1))
		(ai_braindead ext_a_area_a_marines/marines_pelican true)))
...
(script static void cinematic_ext_a_dropship_a
	(begin
		...
		(objects_predict
			(ai_actors ext_a_area_a_cov))
		(sleep 1)
		(vehicle_load_magic ext_a_dropship_wraith_a driver
			(ai_actors ext_a_area_a_cov/wraith_pilot))
...
(script static void cinematic_ext_a_dropship_b
	(begin
		...
		(objects_predict
			(ai_actors ext_a_area_a_cov))
		(vehicle_load_magic ext_a_dropship_turret gunner
			(ai_actors ext_a_area_a_cov/turret_grunts_b))
		...
		(ai_vehicle_enterable_distance ext_a_dropship_ghost_a 15.00)
		(ai_vehicle_enterable_distance ext_a_dropship_ghost_b 15.00)
...
(script static void cinematic_crev_ent_a
	(begin
		...
		(objects_predict
			(ai_actors ext_a_area_c_cov))
		(vehicle_load_magic crev_ent_wraith_a driver
			(ai_actors ext_a_area_c_cov/wraith_a_pilot))
...
(script static void cinematic_crev_ent_b
	(begin
		...
		(objects_predict
			(ai_actors ext_a_area_c_cov))
		(vehicle_load_magic crev_ent_wraith_b driver
			(ai_actors ext_a_area_c_cov/wraith_b_pilot))
...
(script static void cinematic_crev_ent_c
	(begin
		...
		(objects_predict
			(ai_actors ext_a_area_c_cov))
		(vehicle_load_magic crev_ent_ghost_a driver
			(ai_actors ext_a_area_c_cov/ghost_a_pilot))
		(vehicle_load_magic crev_ent_ghost_b driver
			(ai_actors ext_a_area_c_cov/ghost_b_pilot))
		(vehicle_load_magic crev_ent_ghost_c driver
			(ai_actors ext_a_area_c_cov/ghost_c_pilot))
		...
		(ai_vehicle_enterable_distance crev_ent_ghost_a 10.00)
		(ai_vehicle_enterable_distance crev_ent_ghost_b 10.00)
		(ai_vehicle_enterable_distance crev_ent_ghost_c 10.00)
...
(script static void jump_marines
	(begin
		...
		(ai_vehicle_enterable_distance ext_a_pelican_jeep 20.00)))
...
(script dormant void insertion_turrets
	(begin
		(ai_vehicle_enterable_distance insertion_turret_a 10.00)
		(ai_vehicle_enterable_distance insertion_turret_b 10.00)
		...
		(begin_random
			(if a1_spawn
				(begin
					...
					(set a1_spawn_counter
						(+ 1.00 a1_spawn_counter))
					(if
						(= a1_spawn_counter a1_squad_index)
						(set a1_spawn false))))
			(if a1_spawn
				(begin
		...
		(begin_random
			(if a_bridge_rein
				(begin
					...
					(set a_bridge_rein_counter
						(+ 1.00 a_bridge_rein_counter))
					(if
						(= a_bridge_rein_counter a_bridge_rein_index)
...
(script dormant void ini_cinematic_ext_a_pelican
	(begin ini_cinematic_ext_a_pelican))
...
(script dormant void ini_ext_a_banshee
	(begin
		...
		(vehicle_load_magic ext_a_banshee_a driver
			(ai_actors ext_a_area_a_cov/banshee_a_pilot))
		...
		(sleep_until
			(or
				(and
					...
					(=
						(ai_living_count a_bridge/grunts_a) 0))
				(volume_test_objects a_bridge_reins_trigger
					(players))))
		(if
			(or
				(=
...
(script dormant void ini_a2_top_reins
	(begin
		(sleep_until
			(or
				(volume_test_objects a2_top_reins_trigger
					(players))
				(=
		...
		(begin_random
			(if ext_a_spawn
				(begin
					...
					(set ext_a_spawn_counter
						(+ 1.00 ext_a_spawn_counter))
					(if
						(= ext_a_spawn_counter ext_a_squad_index)
...
(script dormant void enc_ext_a_a_cov_second
	(begin
		(if
			(<
				(ai_living_count ext_a_area_a_cov) 10)
...
(script dormant void enc_ext_a_area_b_mar
	(begin
		...
		(sleep 1)
		(objects_predict
			(ai_actors ext_a_area_b_marines))
		(sleep 300)
...
(script continuous void ext_a_migration
	(begin
		(if ext_a_mig_cov
			(begin
				(set ext_a_mig_cov_limit
					(- ext_a_mig_cov_limit 1.00))
				(sleep 1)
				(ai_command_list_by_unit
					(unit
						(list_get
							(ai_actors ext_a_area_b_cov/squad_a) ext_a_mig_cov_limit)) ext_a_area_a_ledge_a)
				(if
					(= ext_a_mig_cov_limit 0)
		...
		(if ext_a_mig_cov
			(begin
				...
				(ai_command_list_by_unit
					(unit
						(list_get
							(ai_actors ext_a_area_b_cov/squad_a) ext_a_mig_cov_limit)) ext_a_area_a_ledge_b)
				(if
					(= ext_a_mig_cov_limit 0)
					(set ext_a_mig_cov false))))
		(inspect ext_a_mig_cov_limit)
		...
		(if ext_a_mig_cov
			(begin
				...
				(ai_command_list_by_unit
					(unit
						(list_get
							(ai_actors ext_a_area_b_cov/squad_a) ext_a_mig_cov_limit)) ext_a_area_a_ledge_c)
				(if
					(= ext_a_mig_cov_limit 0)
					(set ext_a_mig_cov false))))
		(inspect ext_a_mig_cov_limit)
		...
		(if ext_a_mig_cov
			(begin
				...
				(ai_command_list_by_unit
					(unit
						(list_get
							(ai_actors ext_a_area_b_cov/squad_a) ext_a_mig_cov_limit)) ext_a_area_a_ledge_d)
				(if
					(= ext_a_mig_cov_limit 0)
					(set ext_a_mig_cov false))))
		(inspect ext_a_mig_cov_limit)
...
(script dormant void ini_ext_a_area_a_migration
	(begin
		(sleep_until
			(volume_test_objects ext_a_area_a_follow
				(players)))
		...
		(sleep 1)
		(set ext_a_mig_cov_limit
			(ai_living_count ext_a_area_b_cov/squad_a))
		(sleep 1)
		(inspect ext_a_mig_cov_limit)
		(ai_command_list_by_unit
			(unit
		...
		(ai_command_list_by_unit
			(unit
				(list_get
					(ai_actors ext_a_area_b_marines/squad_a) 0)) ext_a_area_a_ledge_b)
		(ai_command_list_by_unit
			(unit
				(list_get
					(ai_actors ext_a_area_b_marines/squad_a) 1)) ext_a_area_a_ledge_c)
		(ai_command_list_by_unit
			(unit
				(list_get
					(ai_actors ext_a_area_b_marines/squad_a) 2)) ext_a_area_a_ledge_b)
		(ai_command_list_by_unit
			(unit
				(list_get
					(ai_actors ext_a_area_b_marines/squad_a) 3)) ext_a_area_a_ledge_c)))
...
(script dormant void ini_ext_a_area_b
	(begin
		...
		(sleep_until
			(volume_test_objects ext_a_area_b_ghosts
				(players)))
		(wake general_save)
		(vehicle_load_magic ext_a_area_b_ghost_a driver
			(ai_actors ext_a_area_b_cov/ghost_a_pilot))
		(vehicle_load_magic ext_a_area_b_ghost_b driver
			(ai_actors ext_a_area_b_cov/ghost_b_pilot))
		...
		(ai_vehicle_enterable_distance ext_a_area_b_ghost_a 15.00)
		(ai_vehicle_enterable_distance ext_a_area_b_ghost_b 15.00)
		...
		(begin_random
			(if crev_ent_turrets
				(begin
					...
					(set crev_ent_turret_counter
						(+ 1.00 crev_ent_turret_counter))
					(if
						(= crev_ent_turret_counter crev_ent_turret_limit)
...
(script continuous void ini_jeep_exit_a
	(begin
		(sleep_until
			(not
				(vehicle_test_seat_list ext_a_jeep w-driver
					(players))))
		(sleep 90)
		(if
			(and
...
(script dormant void enc_crevasse
	(begin
		...
		(sleep 1)
		(objects_predict
			(ai_actors crevasse_cov_a))
		(objects_predict
			(ai_actors crevasse_cov_b))
...
(script dormant void ini_crevasse_reins
	(begin
		(sleep_until
			(>
				(device_group_get garagedoor_c_position) 0.00))
...
(script dormant void ini_crev_dialog
	(begin
		(sleep_until
			(volume_test_objects crev_dialog_trigger
				(players)))
...
(script dormant void enc_ext_b_a_trigger_b
	(begin
		(if
			(<
				(ai_living_count ext_a_area_a_cov) 4)
			(begin
...
(script dormant void enc_ext_b_b
	(begin
		(if
			(<
				(ai_living_count ext_a_area_b_cov) 8)
			(begin
...
(script dormant void enc_ext_b_cave
	(begin
		...
		(if
			(<
				(ai_living_count ext_b_area_b_cov) 8)
			(begin
...
(script dormant void enc_ext_b_c_ini
	(begin
		(if
			(<
				(ai_living_count ext_b_area_c_cov) 3)
			(begin
...
(script dormant void ini_ext_b_tunnel
	(begin
		...
		(sleep 600)
		(ai_vehicle_enterable_distance tunnel_ghost_b 10.00)
...
(script dormant void ini_ext_b_tower
	(begin
		(sleep_until
			(volume_test_objects ext_b_tower_trigger
				(players)))
		(ai_place ext_b_area_a_cov/elites_tower)
		(sleep 1)
		(objects_predict
			(ai_actors ext_b_area_a_cov/elites_tower))))
...
(script dormant void ini_ext_b_trigger_b
	(begin
		(sleep_until
			(volume_test_objects ext_b_a_trigger_b
				(players)))
...
(script dormant void ini_ext_b_trigger_c
	(begin
		(sleep_until
			(volume_test_objects ext_b_a_trigger_c
				(players)))
...
(script dormant void ini_ext_b_b_dropship_a
	(begin ini_ext_b_b_dropship_a
		(sleep_until
			(volume_test_objects ext_b_b_trigger_c
				(players)))
...
(script dormant void ini_pipe_cov
	(begin
		(sleep_until
			(volume_test_objects ext_b_c_trigger_c
				(players)))
...
(script dormant void ini_ext_b_banshee_b
	(begin
		...
		(vehicle_load_magic ext_b_banshee_b driver
			(ai_actors ext_b_area_c_cov/banshee_pilot))
		(sleep 1)
		...
		(begin_random
			(if b3_top_spawn
				(begin
					...
					(set b3_top_spawn_counter
						(+ 1.00 b3_top_spawn_counter))
					(if
						(= b3_top_spawn_counter b3_top_squad_index)
...
(script dormant void ini_b3_top_reins
	(begin
		(sleep_until
			(or
				(volume_test_objects b3_top_reins_trigger
					(players))
				(=
		...
		(sleep_until
			(=
				(ai_living_count b3_top_cov/elites_reins) 0))
...
(script dormant void ini_b3_top_tree
	(begin
		(sleep_until
			(or
				(volume_test_objects b3_top_tree_trigger_a
					(players))
				(volume_test_objects b3_top_tree_trigger_b
					(players))))
		(ai_command_list_by_unit
			(unit
				(list_get
					(ai_actors b3_top_cov/elite_tree) 0)) b3_top_tree)
		(sleep 120)
		(ai_command_list_by_unit
			(unit
				(list_get
					(ai_actors b3_top_cov/elite_tree) 0)) b3_top_tree_off)))
		...
		(begin_random
			(if b4_bridge_spawn
				(begin
					...
					(set b4_bridge_spawn_counter
						(+ 1.00 b4_bridge_spawn_counter))
					(if
						(= b4_bridge_spawn_counter b4_bridge_squad_index)
		...
		(begin_random
			(if c_bridge_spawn
				(begin
					...
					(set c_bridge_spawn_counter
						(+ 1.00 c_bridge_spawn_counter))
					(if
						(= c_bridge_spawn_counter c_bridge_squad_index)
...
(script dormant void enc_c_bridge_reins
	(begin
		...
		(objects_predict
			(ai_actors c_bridge))
		(device_set_position c_bridge_far_door 1.00)))
...
(script dormant void ini_c_bridge_banshee
	(begin
		...
		(sleep_until
			(volume_test_objects c_bridge_banshee_trigger
				(players)) 30
			(* 30.00 15.00))
...
(script dormant void enc_ext_c_ghost_pilots
	(begin
		...
		(vehicle_load_magic ext_c_wraith_a driver
			(ai_actors ext_c_cov/wraith_pilot))
...
(script static void ext_c_ghost_exit_a
	(begin
		...
		(if
			(volume_test_objects ghost_exit_trigger_a
				(ai_actors ext_c_cov/ghost_a))
...
(script static void ext_c_ghost_exit_c
	(begin
		...
		(if
			(volume_test_objects ghost_exit_trigger_c
				(ai_actors ext_c_cov/ghost_c))
...
(script continuous void ini_ext_c_ghosts
	(begin
		...
		(if
			(>=
				(ai_status ext_c_cov/ghost_pilot_a) 5)
			(begin
				(sleep
					(random_range 0 120))
		...
		(if
			(>=
				(ai_status ext_c_cov/ghost_pilot_b) 5)
			(begin
				(sleep
					(random_range 0 120))
		...
		(if
			(>=
				(ai_status ext_c_cov/ghost_pilot_c) 5)
			(begin
				(sleep
					(random_range 0 120))
		...
		(if
			(and
				...
				(<=
					(ai_status ext_c_cov/ghost_a) 2)) ini_ext_c_ghosts)
		(if
			(and
				(>
					(ai_living_count ext_c_cov/ghost_b) 0)
				(<=
					(ai_status ext_c_cov/ghost_b) 2)) ini_ext_c_ghosts)
		(if
			(and
				(>
					(ai_living_count ext_c_cov/ghost_c) 0)
				(<=
					(ai_status ext_c_cov/ghost_c) 2)) ini_ext_c_ghosts)
		(sleep 60)))
...
(script dormant void ini_ext_c_migration
	(begin
		(sleep_until
			(volume_test_objects zig_migration_trigger
				(players)))
		(wake general_save)
...
(script dormant void ini_control_door
	(begin
		...
		(sleep_until
			(>
				(device_get_position control_door_c) 0.00) 5)
...
(script dormant void a_bridge_setup
	(begin
		...
		(objects_predict ext_a_bridge_turret_d) a_bridge_setup))
...
(script dormant void ext_a_setup
	(begin
		(ai_erase a2_top_cov)
		(vehicle_load_magic ext_a_turret_a gunner
			(ai_actors ext_a_area_a_cov/grunts_a))
		(ai_vehicle_enterable_distance ext_a_turret_a 10.00)
...
(script dormant void ext_b_setup
	(begin
		...
		(ai_migrate crev_marines ext_b_marines_ini/squad_y)
		(ai_follow_target_players ext_b_marines_ini/squad_y) ext_b_setup))

(script dormant void ext_c_bridge_setup
	(begin ext_c_bridge_setup
...
(script dormant void ext_c_setup
	(begin ext_c_setup
		...
		(objects_predict ext_c_wraith_a)
		(objects_predict ext_c_ghost_a)
		(device_set_power ext_c_ent_door 1.00)))
...
(script dormant void mission_insertion_b
	(begin
		...
		(sleep_until
			(=
				(device_get_position insertion_door) 0.00))
		(sleep 60)
		...
		(device_set_position insertion_door 1.00)
...
(script dormant void mission_a1
	(begin
		(wake a1_setup)
		(wake general_save)
		(game_save_no_timeout) mission_a1
		(sleep_until
			(=
				(device_get_position a1_entrance_door) 1.00))
		(device_one_sided_set a1_entrance_door false) mission_a1
		(sleep_until
			(volume_test_objects a1_backdoor_trigger
				(players))) mission_a1
...
(script dormant void mission_a_bridge
	(begin
		...
		(sleep_until
			(=
				(device_get_position a_bridge_entrance_door) 1.00))
		...
		(sleep_until
			(volume_test_objects ext_a_banshee_a_trigger
				(players)))
...
(script dormant void mission_a2
	(begin
		...
		(wake music_b40_02)
		(sleep_until
			(volume_test_objects a2_bottom_trigger
				(players)))
		...
		(sleep_until
			(and
				(volume_test_objects a2_tube_trigger
					(players))
				(or
					(objects_can_see_flag
						(players) a2_tub_flag_a 15.00)
					(objects_can_see_flag
						(players) a2_tub_flag_b 15.00))))
		(ai_place a2_bottom_cov/grunts_tub)))

(script dormant void mission_ext_a
	(begin
		(set exterior_player_location 1) mission_ext_a
		(wake ext_a_setup)
		(wake enc_ext_a_cov)
		...
		(if
			(<
				(ai_living_count ext_a_area_b_cov) 6)
		...
		(sleep_until
			(volume_test_objects ext_a_c_follow_trigger
				(players)))
		(wake general_save)
...
(script dormant void mission_crevasse
	(begin
		...
		(sleep_until
			(volume_test_objects crevasse_mig_trigger
				(players)))
...
(script dormant void mission_ext_b
	(begin
		...
		(sleep_until
			(volume_test_objects ext_b_a_trigger_a
				(players)))
		...
		(sleep_until
			(volume_test_objects ext_b_a_trigger_d
				(players)))
		(wake general_save)
		(wake ini_ext_b_trigger_d)
		(wake ini_ext_b_banshee_a)
		(sleep_until
			(volume_test_objects ext_b_b_trigger_a
				(players)) 5)
		...
		(sleep_until
			(volume_test_objects ext_b_b_trigger_b
				(players)))
		(wake general_save)
		(wake enc_ext_b_b_marines)
		(sleep_until
			(volume_test_objects ext_b_b_floor_trigger
				(players)))
		(wake music_b40_041)
		...
		(wake general_save)
		(sleep_until
			(volume_test_objects ext_b_tunnel_trigger
				(players)) 5)
		...
		(sleep_until
			(volume_test_objects ext_b_c_trigger_a
				(players)))
		...
		(sleep_until
			(volume_test_objects ext_b_c_trigger_b
				(players)))
		(set play_music_b40_041 false)
		(wake enc_ext_b_c_final)
		(wake ini_ext_b_banshee_b)
		(sleep_until
			(volume_test_objects ext_b_c_trigger_d
				(players)))
...
(script dormant void mission_b3
	(begin
		...
		(wake music_b40_05)
		(sleep_until
			(volume_test_objects b3_lift_cov_trigger
				(players)))
		(wake enc_b3_lift_cov)
		(ai_erase ext_b_marines)
		(ai_erase ext_b_marines_ini)
		(sleep_until
			(volume_test_objects b3_top_trigger
				(players)))
		(wake general_save)
		(wake enc_b3_top_cov)
...
(script dormant void mission_b3_bridge
	(begin
		...
		(sleep_until
			(volume_test_objects b3_bridge_reins_trigger
				(players)))
		(wake general_save)
		(wake enc_b3_bridge_reins)
		(sleep_until
			(volume_test_objects b4_a_trigger
				(players)) 10)
		(wake general_save)
		(object_create_containing b4_dump)
		(wake enc_b4_a)
		(sleep_until
			(volume_test_objects b4_hall_trigger
				(players)))
		(wake general_save)
		(wake enc_b4_hall)
		...
		(sleep_until
			(volume_test_objects b4_b_trigger
				(players)))
		(wake general_save)
		(wake enc_b4_b)
		...
		(if
			(>
				(ai_status b4_b_cov) 4)
			(ai_magically_see_players b4_b_cov/all))
		(sleep_until
			(volume_test_objects b4_bridge_trigger
				(players)) 10)
		(device_set_power b4_bridge_door 1.00)
		(sleep -1 ini_b4_bridge_cheat)
		(wake enc_b4_bridge_ini)
		(wake music_b40_06)
		(wake general_save)
		(sleep_until
			(volume_test_objects b4_bridge_reins_trigger_a
				(players)))
		(wake general_save)
...
(script dormant void mission_b5
	(begin
		...
		(if
			(>
				(ai_status b5_b_cov) 4)
			(ai_magically_see_players b5_b_cov/all))
		(sleep_until
			(volume_test_objects b5_b_reins_trigger
				(players)))
		(if
			(=
				(ai_living_count b5_b_cov/hunters) 0)
			(wake enc_b5_b_reins_1)
			(wake enc_b5_b_reins_2))
		(sleep 1)
...
(script dormant void mission_control
	(begin
		(sleep_until
			(volume_test_objects control_trigger
				(players)))
		...
		(sleep 300)
		(device_set_position control_door_b 1.00)
		(sleep_until
			(volume_test_objects inside_control
				(players)))
		(ai_migrate control_cov control_cov/inside)
		(sleep_until
			(>
				(device_get_position control_door_c) 0.30))
...
(script dormant void mission_c_bridge
	(begin
		...
		(sleep_until
			(volume_test_objects c_bridge_reins_trigger
				(players)))
...
(script dormant void mission_c1
	(begin
		...
		(wake music_b40_071)
		(sleep_until
			(volume_test_objects c1_bottom_trigger
				(players)))
		(wake enc_c1_bottom)))
...
(script dormant void mission_ext_c
	(begin
		...
		(sleep_until
			(volume_test_objects zig_trigger_a
				(players)))
		(wake general_save)
		(sleep_until
			(volume_test_objects zig_trigger_b
				(players)))
...
(script startup void mission_b40
	(begin
		(fade_out 0.00 0.00 0.00 0) mission_b40
		(cls)
		(switch_bsp 3)
		...
		(wake save_script)
		(sleep_until
			(volume_test_objects a1_trigger
				(players)) 10)
		(wake mission_a1)
		(sleep_until
			(volume_test_objects a_bridge_trigger
				(players)) 10)
		(wake mission_a_bridge)
		(sleep_until
			(volume_test_objects a2_top_trigger
				(players)) 10)
		(wake mission_a2)
		(sleep_until
			(volume_test_objects ext_a_trigger
				(players)) 10)
		(wake mission_ext_a)
		(sleep_until
			(volume_test_objects crevasse_trigger
		...
		(wake mission_ext_b)
		(sleep_until
			(volume_test_objects b3_bottom_trigger
				(players)) 10)
		(wake mission_b3)
		(sleep_until
			(volume_test_objects b3_bridge_trigger
				(players)) 10)
		(wake mission_b3_bridge)
		(sleep_until
			(volume_test_objects b5_a_trigger
				(players)) 10)
		(wake mission_b5)
		(sleep_until
			(volume_test_objects ext_c_trigger_a
		...
		(sleep_until
			(volume_test_objects c1_top_trigger
				(players)) 10)
		(wake mission_c1)
		(sleep_until
			(volume_test_objects ext_c_trigger_b
				(players)) 10)
		(wake mission_ext_c)))
...
(script dormant void pelican_up
	(begin
		...
		(unit_enter_vehicle pelican_up insertion_pelican p-riderlf)
		(unit_enter_vehicle pelican_up insertion_pelican p-riderrf)))

(script dormant void intro_dialogue
	(begin
		(sound_impulse_start sound\dialog\b40\b40_insert_010_pilot none 1.00)
		(print pilot: [radio] this is as far as i can go.)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_insert_010_pilot))
		(sound_impulse_start sound\dialog\b40\b40_insert_020_cortana none 1.00)
		(print cortana: [radio] roger that. we'll be able to find our way to the control center from here.)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_insert_020_cortana))
		(sound_impulse_start sound\dialog\b40\b40_insert_020_pilot none 1.00)
		(print pilot: [radio] good luck. foehammer out.)
		(sleep
			(sound_impulse_time sound\dialog\b40\b40_insert_020_pilot))
		(sound_class_set_gain vehicle 1.00 6)))
...
(script static void pelican
	(begin
		...
		(sleep
			(recording_time insertion_pelican))
		(unit_enter_vehicle pelican insertion_pelican p-riderlf)
		(unit_enter_vehicle pelican insertion_pelican p-riderrf)
		(vehicle_hover insertion_pelican true)
		(unit_exit_vehicle pelican)
		(unit_exit_vehicle pelican)
		(cinematic_stop)
		(show_hud true)
		(sleep 30)
...
(script dormant void extraction_music
	(begin
		(sleep 40)
		(sound_looping_start sound\sinomatixx_music\b40_extraction_music none 1.00)))
