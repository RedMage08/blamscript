...
(global bool global_beach_jeep false)

(global bool global_shafta_start false)

(global bool global_shafta_beach_start false)

(global bool global_shafta_entrance_start false)

(global bool global_shafta_platform_start false)

(global bool global_shafta_descent_start false)

(global bool global_shafta_exit false)

(global long global_shafta_beach_delay
	(* 30.00 150.00))

(global long global_shafta_entrance_delay
	(* 30.00 150.00))

(global long global_shafta_platform_delay
	(* 30.00 150.00))

(global long global_shafta_descent_delay
	(* 30.00 150.00))

(global long global_shafta_switched_delay
	(* 30.00 150.00))

(global long global_shafta_final_delay
	(* 30.00 150.00))

(global bool global_shaftb_beach_start false)

(global bool global_valley_entrance_start false)

(global bool global_valley_mouth_start false)

(global bool global_valley_back_start false)

(global bool global_shaftb_entrance_start false)

(global bool global_shaftb_wide_start false)

(global bool global_shaftb_control_start false)

(global bool global_shaftb_final_start false)

(global bool global_valley_lid_start false)

(global long global_shaftb_beach_delay
	(* 30.00 150.00))

(global long global_valley_entrance_delay
	(* 30.00 150.00))

(global long global_valley_mouth_delay
	(* 30.00 150.00))

(global long global_valley_back_delay
	(* 30.00 150.00))

(global long global_shaftb_entrance_delay
	(* 30.00 150.00))

(global long global_shaftb_wide_delay
	(* 30.00 150.00))

(global long global_shaftb_control_delay
	(* 30.00 150.00))

(global long global_shaftb_final_delay
	(* 30.00 150.00))

(global long global_again_final_delay
	(* 30.00 75.00))

(global bool global_shafta_known_locked false)

(global bool global_shafta_unlocked false)

(global bool global_shafta_inv_active false)

(global bool global_shafta_switched false)

(global bool global_mission_start false)

(global bool mark_lz false)

(global bool mark_map false)

(global bool mark_activate false)

(global bool mark_activate_2 false)

(global bool mark_override false)

(global bool mark_leave false)

(global bool mark_beach_ghost_pass false)

(global bool test_ledge false)

(global bool play_music_b30_01 false)

(global bool play_music_b30_01_alt false)

(global bool play_music_b30_02 false)

(global bool play_music_b30_02_alt false)

(global bool play_music_b30_03 false)

(global bool play_music_b30_03_alt false)

(global bool play_music_b30_04 false)

(global bool play_music_b30_04_alt false)

(global bool play_music_b30_05 false)

(global bool play_music_b30_05_alt false)

(global bool play_music_b30_06 false)

(global bool play_music_b30_06_alt false)

(global bool play_music_b30_07 false)

(global bool play_music_b30_07_alt false)

(global bool play_music_b30_031 false)

(global bool play_music_b30_031_alt false)

(global bool play_music_b30_032 false)

(global bool play_music_b30_032_alt false)
...
(script dormant void music_b30_02
	(begin
		...
		(sound_looping_start levels\b30\music\b30_02 none 1.00)
		(sleep_until
			(or play_music_b30_02_alt
...
(script dormant void music_b30_03
	(begin
		...
		(sound_looping_start levels\b30\music\b30_03 none 1.00)
		(sleep_until
			(or play_music_b30_03_alt
...
(script dormant void music_b30_031
	(begin
		...
		(sound_looping_start levels\b30\music\b30_031 none 1.00)
		(sleep_until
			(or play_music_b30_031_alt
...
(script dormant void music_b30_032
	(begin
		...
		(sound_looping_start levels\b30\music\b30_032 none 1.00)
		(sleep_until
			(or play_music_b30_032_alt
...
(script dormant void music_b30_06
	(begin
		...
		(sound_looping_start levels\b30\music\b30_06 none 1.00)
		(sleep_until
			(or play_music_b30_06_alt
...
(script dormant void music_b30
	(begin
		...
		(sound_looping_start levels\b30\music\b30_04 none 1.00)
...
(script continuous void save_beach_1
	(begin
		(sleep_until
			(and
				(volume_test_objects beach_1
					(players))
				(= 0
					(ai_living_count beach_lz))))
		(set play_music_b30_01 false)
		(game_save)
		(sleep_until
			(not
...
(script continuous void save_beach_3
	(begin
		(sleep_until
			(and
				(volume_test_objects beach_3
					(players))
				(= 0
					(ai_living_count beach_pass))))
		(set play_music_b30_01 false)
		(game_save)
		(sleep_until
			(not
...
(script continuous void save_shafta_entrance
	(begin
		(sleep_until
			(volume_test_objects shafta_entrance
				(players)))
		(set play_music_b30_01 false)
		(game_save)
		(sleep_until
...
(script continuous void save_shaftb_entrance
	(begin
		(sleep_until
			(volume_test_objects shaftb_entrance
				(players)))
		(set play_music_b30_01 false)
		(game_save)
		(sleep_until
...
(script dormant void save_valley_crack
	(begin
		(sleep_until
			(= 0
				(ai_living_count valley_crack)) 10)
		(game_save_no_timeout)))
...
(script dormant void save_valley_canyon
	(begin
		(sleep_until
			(= 0
				(ai_living_count valley_canyon)) 10)
		(game_save_no_timeout)))
...
(script dormant void save_shaftb_wide
	(begin
		(sleep_until
			(= 0
				(ai_living_count shaftb_wide)) 10)
		(game_save_no_timeout)))

(script dormant void save_shafta_beam_enter
	(begin
		(sleep_until
			(volume_test_objects shafta_unlocked
				(players)) 10)
		(sleep_until
			(not
				(volume_test_objects shafta_unlocked
...
(script dormant void save_shafta_beam
	(begin
		(sleep_until
			(= 0
				(ai_living_count shafta_beam)) 10)
		(game_save_no_timeout)))

(script dormant void save_shafta_u_enter
	(begin
		(sleep_until
			(volume_test_objects shafta_u_enter
				(players)) 10)
		(sleep_until
			(not
				(volume_test_objects shafta_u_enter
...
(script dormant void save_shafta_u
	(begin
		(sleep_until
			(= 0
				(ai_living_count shafta_u)) 10)
		(game_save_no_timeout)))

(script dormant void save_shafta_mind_enter
	(begin
		(sleep_until
			(volume_test_objects shafta_jig
				(players)) 10)
		(sleep_until
			(not
				(volume_test_objects shafta_jig
...
(script dormant void save_shafta_mind
	(begin
		(sleep_until
			(= 0
				(ai_living_count shafta_mind)) 10)
		(game_save_no_timeout)))

(script dormant void save_shafta_ante_enter
	(begin
		(sleep_until
			(volume_test_objects shafta_mind
				(players)) 10)
		(sleep_until
			(not
				(volume_test_objects shafta_mind
...
(script dormant void save_shafta_ramp_inv
	(begin
		(sleep_until
			(= 0
				(ai_living_count shafta_ramp_inv)) 10)
		(game_save_no_timeout)))
...
(script dormant void save_shafta_mind_inv
	(begin
		(sleep_until
			(= 0
				(ai_living_count shafta_mind_inv)) 10)
		(game_save_no_timeout)))
...
(script dormant void save_shafta_jig_inv
	(begin
		(sleep_until
			(= 0
				(ai_living_count shafta_jig_inv)) 10)
		(game_save_no_timeout)))
...
(script dormant void save_shafta_u_inv
	(begin
		(sleep_until
			(= 0
				(ai_living_count shafta_u_inv)) 10)
		(game_save_no_timeout)))
...
(script dormant void save_shafta_beam_inv
	(begin
		(sleep_until
			(= 0
				(ai_living_count shafta_beam_inv)) 10)
		(game_save_no_timeout)))
...
(script dormant void save_shafta_switched
	(begin
		(sleep_until
			(not
				(volume_test_objects shafta_switch
					(players))))
		(game_save_no_timeout)))
...
(script dormant void save_shaftb_switched
	(begin
		(sleep_until
			(volume_test_objects shaftb_control_hall
				(players)) 10)
		(game_save_no_timeout)))
...
(script static void cutscene_ledge
	(begin
		...
		(cinematic_start)
		(camera_control true)
		(object_teleport cutscene_ledge player0_ledge_wait)
		(object_teleport cutscene_ledge player1_ledge_wait)
		...
		(sound_looping_start sound\sinomatixx\b30_ledge_foley none 1.00)
		(sleep
			(-
				(camera_time) 15.00))
		(fade_out 1.00 1.00 1.00 15)
		(sleep 15)
		(object_teleport cutscene_ledge player0_ledge_done)
		(object_teleport cutscene_ledge player1_ledge_done)
...
(script static void cutscene_map
	(begin
		(sound_looping_start sound\sinomatixx_foley\b30_map_foley none 1.00)
		(ai false)
		(fade_out 1.00 1.00 1.00 15)
		(sleep 15)
		(switch_bsp 1)
		(cinematic_start)
		(camera_control true)
		(object_teleport cutscene_map player0_map_wait)
		(object_teleport cutscene_map player1_map_wait)
		(object_destroy chief)
		(object_destroy rifle)
		(object_create chief)
		(object_create rifle)
		...
		(sleep 50)
		(device_set_position holohalo_1 1.00)
		(sound_impulse_start sound\dialog\b30\b30_580_cortana none 1.00)
		...
		(fade_out 1.00 1.00 1.00 15)
		(sleep 15)
		(object_teleport cutscene_map player0_map_done)
		(object_teleport cutscene_map player1_map_done)
		(object_destroy chief)
		(camera_control false)
		(cinematic_stop)
		(fade_in 1.00 1.00 1.00 15)
...
(script static void cutscene_extraction_exit
	(begin
		...
		(sound_looping_start sound\sinomatixx_foley\b30_extraction_foley none 1.00)
		(wake pelican_fade)
		...
		(sound_impulse_start sound\dialog\b30\b30_extract_010_cortana none 1.00)
		...
		(sleep
			(camera_time))
		(sleep
			(sound_impulse_time sound\dialog\b30\b30_extract_010_cortana))
		(sound_impulse_start sound\dialog\b30\b30_extract_020_pilot none 1.00)
		...
		(sleep
			(sound_impulse_time sound\dialog\b30\b30_extract_020_pilot))
		(sound_impulse_start sound\dialog\b30\b30_extract_050_cortana none 1.00)
		...
		(sleep
			(sound_impulse_time sound\dialog\b30\b30_extract_050_cortana))
		(sound_impulse_start sound\dialog\b30\b30_extract_060_pilot none 1.00)
		...
		(sound_class_set_gain vehicle_engine 0.30 0)
		...
		(fade_in 0.00 0.00 0.00 15)
		(sleep
			(sound_impulse_time sound\dialog\b30\b30_extract_060_pilot))
		(sound_impulse_start sound\dialog\b30\b30_extract_070_cortana none 1.00)
		(sleep 35)
		...
		(device_set_position lens_machine 0.00)
		...
		(sleep
			(camera_time))
		(sound_class_set_gain vehicle 1.00 0)))

(script dormant void flavor_cutscene_ledge
	(begin
		(sleep_until
			(volume_test_objects shafta_ledge_trigger
				(players)) 5)
		(if
			(game_all_quiet) flavor_cutscene_ledge)))

(script dormant void crack_arrival
	(begin
		(sleep_until
			(or
				(volume_test_objects crack_arrival_trigger
					(players)) global_shafta_unlocked) 10)
		(if
			(not global_shafta_unlocked)
			(ai_conversation crack_arrival))))

(script dormant void shaftb_arrival
	(begin
		(sleep_until
			(or global_shafta_unlocked global_shafta_known_locked))
		(sleep_until
			(or
				(volume_test_objects downed_trigger
					(players)) global_shafta_unlocked) 10)
		(if
			(not global_shafta_unlocked)
...
(script continuous void shafta_killer
	(begin
		(sleep_until
			(volume_test_objects shafta_killer_trigger
				(players)) 5)
		(if
			(volume_test_objects shafta_killer_trigger shafta_killer)
			(damage_object effects\damage effects\guaranteed explosion of doom shafta_killer))
		(if
			(volume_test_objects shafta_killer_trigger shafta_killer)
			(damage_object effects\damage effects\guaranteed explosion of doom shafta_killer))))
...
(script dormant void mission_beach_lz
	(begin
		(sleep_until
			(or
				(> 6
					(ai_living_count beach_lz/camp_toon))
				(volume_test_objects beach_lz_rock
					(players))) 5 delay_dawdle)
		...
		(sleep_until
			(or
				(> 2
					(ai_living_count beach_lz/camp_toon))
				(volume_test_objects beach_lz_camp
					(players))) 5 delay_dawdle)
		...
		(sleep_until
			(or
				(> 7
					(ai_living_count beach_lz/base_toon))
				(volume_test_objects beach_lz_base_attack
					(players))) 5 delay_dawdle)
		...
		(sleep_until
			(or
				(> 3
					(ai_living_count beach_lz/base_toon))
				(volume_test_objects beach_lz_base
					(players))) 5 delay_dawdle)
		(ai_defend beach_lz/base_toon)
		(sleep_until
			(volume_test_objects beach_lz_base
		...
		(sleep_until
			(volume_test_objects beach_lz_arch_attack
				(players)) 5 delay_dawdle)
		(ai_migrate beach_lz_marine beach_lz_marine/marine_arch_attack)
		(sleep_until
			(or
				(> 5
					(ai_living_count beach_lz/arch_toon))
				(volume_test_objects beach_lz_arch
					(players))) 5 delay_dawdle)
		...
		(sleep_until
			(or
				(> 3
					(ai_living_count beach_lz/arch_toon))
				(volume_test_objects beach_lz_arch_back
					(players))) 5 delay_dawdle)
		(ai_retreat beach_lz/arch_toon)
		(ai_migrate beach_lz_marine beach_lz_marine/marine_arch_back)
		(sleep_until
			(= 0
				(ai_living_count beach_lz/arch_toon)) 5 delay_lost)
		(if
			(< 1
				(ai_living_count beach_lz_marine))
			(wake save_beach_lz))
		(set play_music_b30_01 false)
		...
		(sleep
			(recording_time hog_pelican))
		(sleep_until
			(not
				(volume_test_objects jeep_delivery
					(players))) 10)
		...
		(sleep_until
			(< 4
				(ai_conversation_status jeep_load)) 1)
		(sleep_until
			(=
				(ai_going_to_vehicle jeep) 0) 1 delay_dawdle)
		(ai_conversation jeep_go)
		(sleep 45)
		(set mark_map true)
		(objects_predict shafta_cship)
		(objects_predict
			(ai_actors beach_slab))
		(objects_predict
			(ai_actors shafta_entrance))
...
(script dormant void mission_shafta_lock
	(begin
		...
		(sleep_until
			(volume_test_objects shafta_window
				(players)))
		(if global_shafta_unlocked
			(sleep -1))
		...
		(sleep_until
			(or
				...
				(volume_test_objects shafta_slam
					(players))
				(volume_test_objects shafta_entrance
		...
		(sleep_until
			(or
				...
				(volume_test_objects shafta_entrance
					(players))) 1 delay_blink)
		(device_set_position shafta_lock_door 0.00)
		(sleep delay_blink)
		(sleep_until
			(or
				(volume_test_objects shafta_entrance
				...
				(<
					(-
						(ai_living_count shafta_locked)
						(ai_living_count shafta_locked/locker_elite)) 1.00)) 1 delay_late)
		...
		(sleep_until
			(< 4
				(ai_conversation_status shafta_known_locked)) 1)
...
(script dormant void flavor_shafta_inv_cship
	(begin
		...
		(if
			(volume_test_objects shafta_platform jeep)
			(object_destroy jeep))
		(sleep 1)
...
(script dormant void obj_shafta_goal
	(begin
		(sleep_until
			(= 1.00
				(device_group_get map_position)) 1)
		(switch_bsp 1)
		(volume_teleport_players_not_inside shafta_control shafta_control_teleflag)
		(set global_shafta_switched true)
		(if obj_shafta_goal obj_shafta_goal) obj_shafta_goal
		(device_set_position_immediate holohalo_1 1.00)
		(device_set_position_immediate shafta_lock_door 1.00)
		(sleep_until
			(volume_test_objects shafta_entrance
				(players)) 1 300)
		(set mark_leave true)
		...
		(set global_timer
			(+ 90.00
				(game_time)))
		(sleep_until
			(volume_test_objects shafta_entrance_inv
				(players)) 1 90)
...
(script dormant void mission_shafta
	(begin
		...
		(sleep_until
			(volume_test_objects shafta_beach
				(players)) 10)
		...
		(sleep_until
			(or
				...
				(volume_test_objects shafta_platform
					(players))) 1)
			...
			(or
				(and
					(volume_test_objects shafta_entrance
						(players))
					(> 4
						(ai_status shafta_entrance/interior)))
				(= 0
					(ai_living_count shafta_entrance/interior))
				(volume_test_objects shafta_entrance_past
					(players))
				(volume_test_objects beach_3
					(players))
				(volume_test_objects beach_5
		...
		(sleep_until
			(< 4
				(ai_conversation_status shafta_entered)) 1)
		...
		(sleep_until
			(volume_test_objects shafta_jig
				(players)) 10 delay_lost)
		(set play_music_b30_032 false)
		(sleep_until
			(volume_test_objects shafta_jig
				(players)) 1)
		(if
			(not global_shafta_switched)
			(ai_conversation shafta_descent))
		(sleep_until
			(and
				(= 0
					(ai_living_count shafta_ante/rein_elite))
				(volume_test_objects shafta_switch
					(players))) 10)
		(if
			(not global_shafta_switched)
...
(script dormant void mission_shafta_inv
	(begin
		...
		(sleep_until
			(or
				(volume_test_objects shafta_booth
					(players))
				(volume_test_objects shafta_ramp
					(players))) 10)
		(game_save_no_timeout)
		(sleep 3)
		...
		(sleep_until
			(volume_test_objects shafta_beam
				(players)) 10)
		(set play_music_b30_05_alt false)
...
(script dormant void flavor_lid_cship
	(begin
		...
		(sleep_until
			(volume_test_objects valley_mouth
				(players)) 10)
...
(script static void cutscene_shaftb_goal
	(begin
		...
		(object_teleport
			(list_get
				(ai_actors unlock_elite) 0) locker_elite_flag)
		(sleep 30)
		(cinematic_start)
		(show_hud false)
		(camera_control true)
		...
		(sleep 60)
		(device_set_position shafta_lock_door 1.00)
		(sleep 30)
		(ai_command_list unlock_elite shafta_unlock_1)
		(if global_shafta_known_locked
			(ai_conversation shaftb_switch_known)
			(ai_conversation shaftb_switch_unknown))
		(sleep
			(camera_time))
		(sleep 60)
		(fade_out 0.00 0.00 0.00 30)
...
(script dormant void mission_shaftb
	(begin
		(sleep_until
			(volume_test_objects valley_entrance
				(players)))
		...
		(sleep_until
			(volume_test_objects valley_back
				(players)))
		...
		(sleep_until
			(volume_test_objects shaftb_control
				(players)))
		(if global_shafta_known_locked
			(ai_conversation shaftb_switchit_known)
			(ai_conversation shaftb_switchit_unknown))
		(sleep_until
			(= 0.00
				(device_group_get shaftb_switch_position)) 1)
...
(script dormant void mission_crash
	(begin
		...
		(sleep_until
			(volume_test_objects shaftb_wide
				(players)) 1)
		...
		(ai_place downed)
		(sleep_until
			(volume_test_objects shaftb_entrance_inv
				(players)) 1)
		(set play_music_b30_031_alt false)
		(set play_music_b30_031 false)
		(sleep_until
			(or
				(volume_test_objects downed_trigger
					(players))
				(volume_test_objects downed_trigger_2
					(players))
				(objects_can_see_object
					(players) downed_dropship 5.00)) 1)
		(ai_conversation downed_seen)))

(script startup void cutscene_insertion
	(begin
		(sound_looping_start sound\sinomatixx_foley\b30_insertion_foley none 1.00)
		(sound_class_set_gain vehicle 0.30 0)
		...
		(ai_place beach_lz)
		(unit_enter_vehicle cutscene_insertion insertion_pelican_1 p-riderlf)
		(unit_enter_vehicle cutscene_insertion insertion_pelican_2 p-riderlf)
		(vehicle_load_magic insertion_pelican_1 rider
			(ai_actors beach_lz_marine/left_marine))
		(vehicle_load_magic insertion_pelican_2 rider
			(ai_actors beach_lz_marine/right_marine))
		...
		(sleep 30)
		(sound_impulse_start sound\dialog\b30\b30_insert_010_cortana none 1.00)
		(sleep
			(sound_impulse_time sound\dialog\b30\b30_insert_010_cortana))
		(sleep 30)
		(sound_impulse_start sound\dialog\b30\b30_insert_020_cortana none 1.00)
		(sleep
			(sound_impulse_time sound\dialog\b30\b30_insert_020_cortana))
		(sleep
			(max 0.00
				(-
					(recording_time insertion_pelican_1) 900.00)))
		(sound_impulse_start sound\dialog\b30\b30_insert_030_pilot none 1.00)
		(sleep
			(sound_impulse_time sound\dialog\b30\b30_insert_030_pilot))
		(sleep
			(max 0.00
				(-
					(recording_time insertion_pelican_1) 300.00)))
		(sound_impulse_start sound\dialog\b30\b30_insert_040_pilot none 1.00)
		(sleep
			(sound_impulse_time sound\dialog\b30\b30_insert_040_pilot))
		(sleep
			(max 0.00
				(-
					(recording_time insertion_pelican_1) 120.00)))
		(cinematic_stop)
		(show_hud true)
		...
		(sound_class_set_gain vehicle 1.00 2)
		(sleep 60)
		(vehicle_unload insertion_pelican_2 rider)
		(sound_impulse_start sound\dialog\b30\b30_insert_050_sarge2 none 1.00)
		(sleep 30)
		(vehicle_unload insertion_pelican_1 rider)
		(sleep_until
			(not
				(volume_test_objects mission_start
					(players))))
		...
		(sleep
			(recording_time insertion_pelican_2))
