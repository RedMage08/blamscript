...
(global real keyes_dialogue_scale 1.00)
...
(global real music_05_scale 1.00)

(global real music_06_scale 1.00)
...
(global bool music_03_alt false)

(global bool music_04_base false)

(global bool music_05_base false)

(global bool music_06_base false)
...
(global bool skin_diver false)

(global bool bloodthirsty false)

(global bool save_now false)

(global bool enc3_4_spawn_in_water true)
...
(global bool cortana_told_you_to_jump false)

(global bool enc1_1_door1 false)

(global bool enc1_1_door2 false)

(global bool enc1_1_door3 false)

(global bool enc1_1_door4 false)

(global bool enc1_1_doors true)
	...
	(begin
		(if
			(>
				(list_count
					(players)) 1)
			(begin outro_banshees outro_banshees)
			(begin
				(if
					(vehicle_test_seat_list ending_banshee1 b-driver
						(players))
					(begin outro_banshees
...
(script static void cinematic_outro
	(begin
		...
		(vehicle_load_magic ending_banshee1 b-driver cinematic_outro)
		(vehicle_load_magic ending_banshee2 b-driver cinematic_outro) cinematic_outro
		(sleep 100)
		(sound_class_set_gain ambient_machinery 0.00 3)
...
(script static void cutscene_captain
	(begin
		(sound_looping_start sound\sinomatixx_foley\d20_captain_foley none 1.00)
		(wake captain_music)
		...
		(sleep 15)
		(switch_bsp 4)
		(object_teleport cutscene_captain player0_capt_base)
		(object_teleport cutscene_captain player1_capt_base)
		...
		(sound_impulse_start sound\dialog\d20\d20_captflood_030_cortana none 1.00)
		...
		(sleep 60)
		(sound_impulse_start sound\dialog\d20\d20_captflood_050_cortana none 1.00)
		...
		(sound_looping_start sound\sinomatixx_foley\d20_captain_foley2 none 1.00)
		(sleep 30)
		(sound_impulse_start sound\dialog\d20\d20_captflood_060_cortana none 1.00)
		(print cortana: what he'd want us to do.)
		(sleep 120)
		(print rumble)
		(player_effect_set_max_rotation 0.00 0.75 0.75)
		...
		(object_destroy implants)
		(sleep 40)
		(sound_impulse_start sound\dialog\d20\d20_captflood_061_cortana none 1.00)
		...
		(fade_out 1.00 1.00 1.00 15)
		(sleep 15)
		(object_teleport cutscene_captain player0_capt_done)
		(object_teleport cutscene_captain player1_capt_done)
...
(script static void cinematic_captain
	(begin cinematic_captain))

(script static void cutscene_lift
	(begin
		(sound_looping_start sound\sinomatixx_music\d20_lift_music none 1.00)
		(sound_looping_start sound\sinomatixx_foley\d20_lift_foley none 1.00)
		(objects_predict chief)
		(objects_predict rifle)
		(fade_out 1.00 1.00 1.00 15)
		(camera_control true)
		...
		(sleep 15)
		(switch_bsp 1)
		(object_teleport cutscene_lift player0_lift_base)
		(object_teleport cutscene_lift player1_lift_base)
		...
		(sleep 15)
		(switch_bsp 2)
		(object_teleport cutscene_lift player0_afterlift_base)
		(object_teleport cutscene_lift player1_afterlift_base)
		(object_destroy chief)
		(object_destroy rifle)
		(cinematic_stop)
		(camera_control false)
...
(script static void cutscene_fall
	(begin
		...
		(sleep 15)
		(switch_bsp 1)
		(object_teleport cutscene_fall player0_fall_base)
		(object_teleport cutscene_fall player1_fall_base)
		(object_destroy chief)
		(object_destroy rifle)
		(object_create chief)
		(object_create rifle)
		...
		(sleep 40)
		(sound_looping_start sound\sinomatixx_foley\d20_fall_foley none 1.00)
		(sleep 20)
		...
		(player_effect_start 1.00 0.00)
		(player_effect_stop 1.00)
		(fade_out 0.09 0.26 0.21 15)
		(sleep 15)
		(object_destroy chief)
		(object_destroy rifle)
		(object_teleport cutscene_fall player0_afterfall_base)
		(object_teleport cutscene_fall player1_afterfall_base)
		(cinematic_stop)
		(camera_control false)
		(fade_in 0.09 0.26 0.21 15)))

(script static void cinematic_drop
	(begin cinematic_drop))

(script static void cutscene_insertion
	(begin
		(sound_class_set_gain weapon_fire 0.30 0)
		(sound_class_set_gain projectile_detonation 0.30 0)
		(sound_class_set_gain projectile_impact 0.30 0)
		(sound_class_set_gain unit_footsteps 0.30 0)
		(sound_class_set_gain unit_dialog 0.00 0)
		(sound_class_set_gain ambient_nature 0.30 0)
		(sound_class_set_gain ambient_machinery 0.30 0)
		(objects_predict chief)
		(objects_predict rifle)
		(fade_out 0.00 0.00 0.00 0)
		(camera_control true)
		(cinematic_start)
		(object_teleport cutscene_insertion player0_insert_base)
		(object_teleport cutscene_insertion player1_insert_base)
		...
		(sleep 5)
		(sound_looping_start sound\sinomatixx_music\d20_insertion_music none 1.00)
		(sound_looping_start sound\sinomatixx_foley\d20_insertion_foley none 1.00)
		(sleep 25)
		(camera_set fly_1b 250)
		(object_pvs_set_camera fly_1b)
		(fade_in 0.00 0.00 0.00 30)
		(sound_impulse_start sound\dialog\d20\d20_insert_010_cortana none 1.00)
		(sleep 125)
		...
		(sleep 125)
		(sound_impulse_start sound\dialog\d20\d20_insert_020_cortana none 1.00)
		...
		(sleep 125)
		(sound_impulse_start sound\dialog\d20\d20_insert_030_cortana none 1.00)
		...
		(fade_in 1.00 1.00 1.00 15)
		(sleep 10)
		(sound_looping_start sound\sinomatixx_foley\d20_insertion_foley2 none 1.00)
		(sleep 5)
		...
		(object_pvs_clear)
		(object_teleport cutscene_insertion chief_insert_base)
...
(script static void d20_10_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_010_cortana) 30.00)))))
...
(script static void d20_20_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_020_cortana) 30.00)))))
...
(script static void d20_30_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_030_cortana) 30.00)))))
...
(script static void d20_50_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_050_cortana) 30.00)))))
...
(script static void d20_70_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_070_cortana) 30.00)))))
...
(script static void d20_71_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_071_cortana) 30.00)))))
...
(script static void d20_72_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_072_cortana) 30.00)))))
...
(script static void d20_73_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_073_cortana) 30.00)))))
...
(script static void d20_90_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_090_cortana) 30.00)))
...
(script static void d20_120_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_120_cortana) 30.00)))))
...
(script static void d20_130_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_130_cortana) 30.00)))))
...
(script static void d20_140_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_140_cortana) 30.00)))
...
(script static void d20_150_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_150_cortana) 30.00)))))
...
(script static void d20_160_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_160_cortana) 30.00)))))
...
(script static void d20_180_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_180_cortana) 30.00)))))
...
(script static void d20_190_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_190_cortana) 30.00)))
...
(script static void d20_200_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_200_cortana) 30.00)))))
...
(script static void d20_210_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_210_cortana) 30.00)))
...
(script static void d20_220_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_220_cortana) 30.00)))
...
(script static void d20_240_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_240_cortana) 30.00)))))
...
(script static void d20_250_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_250_cortana) 30.00)))
		(activate_team_nav_point_object default_red player ending_banshee1 0.00)))
...
(script static void d20_flavor_010_captkeyes
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_flavor_010_captkeyes) 15.00)))))
...
(script static void d20_flavor_020_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_flavor_020_cortana) 15.00)))))
...
(script static void d20_flavor_030_captkeyes
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_flavor_030_captkeyes) 15.00)))))
...
(script static void d20_flavor_040_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_flavor_040_cortana) 15.00)))))
...
(script static void d20_flavor_050_captkeyes
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_flavor_050_captkeyes) 15.00)))))
...
(script static void d20_flavor_060_cortana
	(begin
		...
		(sleep
			(max 0.00
				(-
					(sound_impulse_time sound\dialog\d20\d20_flavor_060_cortana) 15.00)))))
...
(script dormant void music_control
	(begin music_control music_control music_control music_control music_control))
...
(script dormant void i_am_skin_diver
	(begin
		...
		(object_set_permutation
			(list_get
				(ai_actors med1_flood) 0) head ~damaged)
		(object_set_permutation
			(list_get
				(ai_actors med1_flood) 0) left arm ~damaged)
		(object_set_permutation
			(list_get
				(ai_actors med1_flood) 1)  ~damaged)
		(object_set_permutation
			(list_get
				(ai_actors med1_flood) 2)  ~damaged)
		(object_set_permutation
			(list_get
				(ai_actors med1_flood) 2) left arm ~damaged)
		(object_set_permutation
			(list_get
				(ai_actors med1_flood) 3)  ~damaged)
		(object_set_permutation
			(list_get
				(ai_actors med1_flood) 4) right arm ~damaged)
		(object_set_permutation
			(list_get
				(ai_actors med1_flood) 4) left arm ~damaged)
		(sleep_until
			(= 0
				(ai_living_count med1_flood)))
		(set skin_diver true)))
...
(script dormant void more_blood_for_me
	(begin
		(sleep_until
			(>
				(ai_living_count enc5_7_cov/specops) 0))
		(sleep_until
			(= 0
				(ai_living_count enc5_7_cov/specops)))
		(sleep_until
			(>
				(ai_living_count enc7_1_cov) 0))
		(sleep_until
			(= 0
				(ai_living_count enc7_1_cov)))
		(sleep_until
			(>
				(ai_living_count enc7_3) 0))
		(sleep_until
			(= 0
				(ai_living_count enc7_3)))
	...
	(begin
		(sleep_until
			(volume_test_objects section7
				(players)) testing_save)
		(if debug
			(print saved at checkpoint 7.1))
		(sleep_until
			(game_safe_to_save)) save_checkpoint7_1))
...
(script static void save_checkpoint6_1
	(begin
		...
		(sleep_until
			(game_safe_to_save)) save_checkpoint6_1))

(script static void save_checkpoint5_1
	(begin
		(sleep_until
			(volume_test_objects save_point5_1
				(players)) testing_save)
		(if debug
			(print saved at checkpoint 5.1))
		(sleep_until
			(game_safe_to_save)) save_checkpoint5_1))

(script static void save_checkpoint4_2
	(begin
		(sleep_until
			(volume_test_objects save_point4_2
				(players)) testing_save)
		(if debug
			(print saved at checkpoint 4.2))
		(sleep_until
			(game_safe_to_save)) save_checkpoint4_2))

(script static void save_checkpoint4_1
	(begin
		(sleep_until
			(volume_test_objects save_point4_1
				(players)) testing_save)
		(if debug
			(print saved at checkpoint 4.1))
		(sleep_until
			(game_safe_to_save)) save_checkpoint4_1))

(script static void save_checkpoint3_2
	(begin
		(sleep_until
			(volume_test_objects save_point3_2
				(players)) testing_save)
		(if debug
			(print saved at checkpoint 3.2))
		(sleep_until
			(game_safe_to_save)) save_checkpoint3_2))

(script static void save_checkpoint3_1
	(begin
		(sleep_until
			(volume_test_objects save_point3_1
				(players)) testing_save)
		(if debug
			(print saved at checkpoint 3.1))
		(sleep_until
			(game_safe_to_save)) save_checkpoint3_1))
...
(script static void save_checkpoint1_1
	(begin
		...
		(sleep_until
			(game_safe_to_save)) save_checkpoint1_1))

(script dormant void save_checkpoints
	(begin
		(if debug
			(print save checkpoints running...)) save_checkpoints save_checkpoints save_checkpoints save_checkpoints save_checkpoints save_checkpoints))

(script continuous void enc7_5_spawner
	(begin
		(if
			(and
				(volume_test_objects_all enc7_5
					(players))
				(<
	...
	(begin
		(if
			...
			(begin
				(if
					(<
						(ai_living_count enc4_4/combats) min_combat_spawn)
					(begin
				...
				(if
					(<
						(ai_living_count enc4_4/carriers) min_carrier_spawn)
					(begin
				...
				(if
					(<
						(ai_living_count enc4_4/infs) min_infection_spawn)
					(begin
	...
	(begin
		(if
			(and
				(< enc4_2_limiter
					(* 40.00 spawn_scale))
				(volume_test_objects enc4_2b
					(players)))
			(begin
				(if
					(<
						(ai_living_count enc4_2)
						(+
							(ai_living_count enc4_2/carriers1) min_carrier_spawn))
					(begin
						(if
							(objects_can_see_flag
								(players) enc4_2_forward 30.00)
				...
				(if
					(<
						(ai_living_count enc4_2/infs) min_infection_spawn)
	...
	(begin
		(if
			...
			(begin
				(if
					(<
						(ai_living_count enc3_8_flood/combats)
				...
				(if
					(<
						(ai_living_count enc3_8_flood/carriers)
	...
	(begin
		(if
			...
			(begin
				(if
					(<
						(ai_living_count enc3_5_flood/combats)
						(* 2.00 min_combat_spawn))
					(begin
	...
	(begin
		(if
			...
			(begin
				(if
					(<
						(ai_living_count enc3_4_flood/combats) 1)
					(begin
		...
		(if enc3_4_spawn_in_water
			(if
				(<
					(ai_nonswarm_count enc3_4_flood/water) min_carrier_spawn)
	...
	(begin
		(if
			...
			(begin
				(if
					(<
						(ai_living_count enc3_2_flood/combats)
				...
				(if
					(<
						(ai_living_count enc3_2_flood/carriers)
						(* min_carrier_spawn 2.00))
					(begin
				...
				(if
					(<
						(ai_living_count enc3_2_flood/infs) min_infection_spawn)
...
(script continuous void enc1_5_spawner
	(begin
		(if
			(and
				(volume_test_objects_all enc1_5_spawner
					(players))
				(< enc1_5_limiter
					(* 60.00 spawn_scale)))
			(begin
				(if
					(<=
						(ai_living_count enc1_5_flood/combats)
						(*
							(+
								(/ enc1_5_limiter 20.00) 1.00) min_combat_spawn))
					(begin
				...
				(if
					(<
						(ai_living_count enc1_5_flood/carriers) min_carrier_spawn)
					(begin
				...
				(if
					(<=
						(ai_living_count enc1_5_flood/infections)
						(* 2.00 min_infection_spawn))
...
(script static void enc3_3_banshees
	(begin
		...
		(recording_play
			(unit enc3_3_banshee1) enc3_3_banshee1)
		(recording_play
			(unit enc3_3_banshee2) enc3_3_banshee2)
		(sleep
			(max
				(recording_time enc3_3_banshee1)
				(recording_time enc3_3_banshee2)))
...
(script static void enc3_9_banshees
	(begin
		...
		(recording_play
			(unit enc3_9_banshee1) enc3_9_banshee1)
		(sleep 75)
		(object_create enc3_9_banshee2)
		(object_teleport enc3_9_banshee2 enc3_9_banshee1)
		(recording_play
			(unit enc3_9_banshee2) enc3_9_banshee2)
		(sleep
			(recording_time enc3_9_banshee1))
		(object_destroy enc3_9_banshee1)
		(sleep
			(recording_time enc3_9_banshee2))
		...
		(sleep_until
			(or
				(objects_can_see_object
					(players) ending_banshee1 10.00)
				(objects_can_see_object
					(players) ending_banshee2 10.00)))))
...
(script continuous void banshee_safety_net
	(begin
		(sleep_until
			(and
				(not
					(volume_test_objects enc7_6c ending_banshee1))
				(not
					(volume_test_objects enc7_6c ending_banshee2))))
...
(script static void ending_banshees
	(begin ending_banshees ending_banshees
		(sleep 90) ending_banshees
		(ai_place enc7_4)
		(ai_force_active enc7_4 true)
		(vehicle_load_magic outro_dropship passenger
			(ai_actors enc7_4/grunts))
		(vehicle_load_magic ending_banshee1 b-driver
			(list_get
				(ai_actors enc7_4/elites1) 0))
		(vehicle_load_magic ending_banshee2 b-driver
			(list_get
				(ai_actors enc7_4/elites2) 0))
		(ai_braindead enc7_4 true)
		(wake banshee_hook)
		(if
			(<
				(recording_time ending_banshee1)
				(recording_time ending_banshee2))
			(begin
				(sleep
					(recording_time ending_banshee1))
		...
		(sleep
			(max 0.00
				(-
					(recording_time outro_dropship) 90.00)))
		(unit_open
			(unit outro_dropship))
		(sleep
			(recording_time outro_dropship))
...
(script continuous void enc7_6_manager
	(begin
		(sleep_until
			(and
				(volume_test_objects_all enc7_6
					(players))
				(<= enc7_6_limiter
					(* spawn_scale 8.00))))
		(if
			(<=
				(ai_living_count enc7_6_cov/exit_grunts) 1)
			(begin
		...
		(if
			(<=
				(ai_living_count enc7_6_cov/lower_elites) 1)
			(begin
		...
		(if
			(<=
				(ai_living_count enc7_6_cov/upper_elites) 1)
			(begin
...
(script dormant void enc7_6
	(begin
		(sleep_until
			(volume_test_objects enc7_6
				(players))) enc7_6
		(if debug
			(print encounter 7.6...))
		(wake enc7_6_manager)
		(sleep_until
			(volume_test_objects enc7_6c
				(players))) enc7_6
		(if
			(<=
				(ai_living_count enc7_6_cov) 2)
			(ai_place enc7_6_cov))))
...
(script dormant void enc7_3
	(begin
		(sleep_until
			(volume_test_objects enc7_3
				(players)) testing_fast)
		(if debug
			(print encounter 7.3...)) enc7_3
...
(script dormant void enc7_2
	(begin
		(sleep_until
			(or
				(volume_test_objects enc7_2
					(players))
				(volume_test_objects enc7_2b
					(players))
				(volume_test_objects enc7_2c
					(players))))
		(if debug
			(print encounter 7.2...)) enc7_2
		(wake enc7_3) enc7_2
		(sound_looping_start levels\d20\music\d20_06 none 1.00) enc7_2
		(wake enc7_6)
		(sleep_until
			(or
				(vehicle_test_seat_list ending_banshee1 b-driver
					(players))
				(vehicle_test_seat_list ending_banshee2 b-driver
					(players))))
...
(script continuous void enc6_2_manager
	(begin
		...
		(if
			(<=
				(ai_living_count enc6_1_flood/combats)
				(* 2.00 min_combat_spawn))
			(begin
		...
		(if
			(<=
				(ai_living_count enc6_1_flood/carriers) 1)
			(begin
...
(script continuous void enc6_1_manager
	(begin
		...
		(if
			(<=
				(ai_living_count enc6_1_flood/combats) 1)
			(ai_spawn_actor enc6_1_flood/combats))
		(if
			(and
				(<=
			...
			(if
				(not
					(volume_test_objects enc6_1b
						(players)))
				(ai_place enc6_1_cov/reins1)
				(if
					(not
						(volume_test_objects enc6_1c
							(players)))
...
(script continuous void enc6_5_manager
	(begin
		(sleep_until
			(and
				(not
					(volume_test_objects enc6_4_stopper
						(players)))
				(<= enc6_5_limiter
					(* 6.00 spawn_scale))))
		(if
			(and
				...
				(<=
					(ai_nonswarm_count enc6_5_flood/left_door)
					(* 2.00 min_combat_spawn)))
			(begin
		...
		(if
			(and
				...
				(<=
					(ai_nonswarm_count enc6_5_flood/right_door)
					(* 2.00 min_combat_spawn)))
			(begin
...
(script dormant void enc6_5
	(begin
		(if debug
			(print encounter 6.5...))
		(device_set_power enc6_5_door1 1.00)
		(device_set_power enc6_5_door2 1.00)
		(device_operates_automatically_set enc6_5_door1 true)
		(device_operates_automatically_set enc6_5_door2 true)
		(device_set_position enc6_5_door3 0.00)
		(device_set_power enc6_5_door3 0.00)
		...
		(sleep_until
			(and
				(volume_test_objects enc6_3
					(players))
				(not
					(volume_test_objects enc6_3_safe
						(ai_actors enc6_1_flood)))))
		(sleep -1 enc6_2_manager)
		(if debug
			(print encounter 6.3...))
		(sound_looping_stop levels\d20\music\d20_05)
		(sleep 30) enc6_3 enc6_3
		(deactivate_team_nav_point_flag player waypoint5)
		(wake enc6_4)
		(sleep 60) enc6_3 enc6_3
		(sound_looping_start levels\d20\music\d20_051 none 1.00)
		(wake enc6_5)
		(wake section7) enc6_3))
...
(script dormant void enc6_2
	(begin
		...
		(wake enc6_2_manager)
		(if debug
			(print encounter 6.2...)) enc6_2 enc6_2 enc6_2
		(wake enc6_3)
		(sleep_until
			(volume_test_objects enc6_4
				(players)))
...
(script dormant void chapter_3_test
	(begin
		(sleep_until
			(volume_test_objects enc7_1
				(players))) chapter_3_test
		(sleep 45) chapter_3_test chapter_3_test
		(sound_looping_start levels\d20\music\d20_05 none 1.00)
		(deactivate_team_nav_point_flag player waypoint5)))
...
(script dormant void enc5_7_dropship_delivery
	(begin
		...
		(vehicle_load_magic enc5_7_dropship passenger
			(ai_actors enc5_7_cov/specops))
		(recording_play
			(unit enc5_7_dropship) enc5_7_dropship)
		(sleep 640)
		(vehicle_unload enc5_7_dropship passenger)
		(ai_braindead enc5_7_cov/specops false)
		(sleep
			(recording_time enc5_7_dropship))
...
(script continuous void enc5_7_manager
	(begin
		...
		(if
			(<=
				(ai_nonswarm_count enc5_7_flood/reins)
				(* 2.00 min_combat_spawn))
			(begin
...
(script dormant void enc5_7
	(begin
		(sleep_until
			(volume_test_objects enc5_7
				(players)))
		(if debug
			(print encounter 5.7...)) enc5_7
...
(script dormant void enc5_6
	(begin
		(sleep_until
			(volume_test_objects enc5_6
				(players)))
		(if debug
			(print encounter 5.6...)) enc5_6
		(ai_place enc5_6)
...
(script dormant void enc5_5
	(begin
		(sleep_until
			(volume_test_objects enc5_5
				(players)))
		(if debug
			(print encounter 5.5...)) enc5_5
		(ai_place enc5_5_cov)
...
(script dormant void enc5_4
	(begin
		(sleep_until
			(volume_test_objects enc5_4
				(players)))
		(wake enc5_5)
		(wake enc5_6)
		(wake enc5_7)
		(if debug
			(print encounter 5.4...)) enc5_4
		(ai_place enc5_4_cov)
...
(script dormant void enc5_3
	(begin
		(sleep_until
			(or
				(volume_test_objects enc5_3
					(players))
				(volume_test_objects enc5_3b
					(players))))
		(if debug
			(print encounter 5.3...)) enc5_3
		(ai_place enc5_3_cov)
...
(script continuous void enc5_1_manager
	(begin
		...
		(if
			(<=
				(ai_living_count enc5_1_flood/upper_combats) min_combat_spawn)
			(begin
		...
		(if
			(<=
				(ai_living_count enc5_1_cov/gunner_elites) 1)
			(begin
		...
		(if
			(<=
				(ai_living_count enc5_1_cov/gunner_grunts) 1)
			(begin
		...
		(sleep_until
			(or
				(volume_test_objects enc5_2
					(players))
				(volume_test_objects enc5_2b
					(players))))
		(if debug
			(print encounter 5.2...)) enc5_2
...
(script dormant void enc5_1
	(begin
		...
		(wake enc5_1_manager)
		(sleep_until
			(volume_test_objects enc5_1
				(players))) enc5_1
		(sleep 150) enc5_1 enc5_1
		(sound_looping_start levels\d20\music\d20_04 none 1.00)
		(sleep_until
			(volume_test_objects enc5_6
				(players)))
		(sleep -1 enc5_1_manager)
...
(script dormant void section5
	(begin
		...
		(ai_vehicle_enterable_distance enc5_1_turret 10.00)
		(wake enc5_1)
		(wake enc5_2)
		(wake enc5_3)
		(wake enc5_4)
...
(script dormant void enc4_9
	(begin
		(sleep_until
			(volume_test_objects enc4_9
				(players)))
		(if debug
			(print encounter 4.9...)) enc4_9
		(ai_place enc4_9_cov)
		(sleep_until
			(volume_test_objects enc4_9b
				(players)) testing_fast)
...
(script continuous void enc4_8_manager
	(begin
		(sleep_until
			(and
				(volume_test_objects_all enc4_8_spawner
					(players))
				(<= enc4_8_limiter
					(* 6.00 spawn_scale))))
		(if
			(<=
				(ai_nonswarm_count enc4_8/combats) min_combat_spawn)
			(begin
		...
		(if
			(<=
				(ai_nonswarm_count enc4_8/combats_upper) min_combat_spawn)
			(begin
...
(script dormant void enc4_8
	(begin
		(sleep_until
			(volume_test_objects enc4_8
				(players)))
		(if debug
			(print encounter 4.8...)) enc4_8
		(object_destroy_containing 2_)
		(ai_place enc4_8)
		(sleep_until
			(volume_test_objects_all enc4_8_spawner
				(players)))
		(device_set_position_immediate enc4_8_door 1.00)
		(wake enc4_8_manager)
		(sleep_until
			(volume_test_objects section5
				(players)))
...
(script dormant void enc4_7
	(begin
		(sleep_until
			(volume_test_objects enc4_7
				(players)))
		(wake enc4_9)
		(if debug
			(print encounter 4.7...)) enc4_7
		...
		(sleep_until
			(<=
				(ai_living_count enc4_7_flood/combats) 0))
		(ai_maneuver enc4_7_cov)))

(script dormant void enc4_6
	(begin
		(sleep_until
			(volume_test_objects enc4_6
				(players)))
		...
		(wake enc4_8)
		(if debug
			(print encounter 4.6...)) enc4_6
		(ai_place enc4_6)))

(script dormant void enc4_5
	(begin
		(sleep_until
			(volume_test_objects enc4_5
				(players)))
		(wake enc4_6)
		(if debug
			(print encounter 4.5...)) enc4_5
		(ai_place enc4_5/infs)
		(ai_place enc4_5/init_combats)
		(sleep_until
			(<=
				(ai_nonswarm_count enc4_5) 2))
		(if
			(not
				(volume_test_objects enc4_5b
					(players)))
...
(script dormant void enc4_3
	(begin
		...
		(wake enc4_5)
		(if debug
			(print encounter 4.3...)) enc4_3
		(ai_place enc4_3/combats)
		(ai_place enc4_3/carriers)
		(ai_place enc4_3/infs)
		(sleep -1 enc4_2_spawner)
		(sound_looping_start levels\d20\music\d20_03 none 1.00)
		(wake enc4_3_dialogue)
		(sleep_until
			(or
				(<
					(ai_strength enc4_3) 1.00)
				(volume_test_objects enc4_3c
					(players))))
		(sleep_until
			(<=
				(ai_nonswarm_count enc4_3) 2))
		(sleep_until
			(volume_test_objects enc4_3c
				(players)) 30 900)
		(sound_looping_set_alternate levels\d20\music\d20_03 true)
		(sleep 60)
		(device_group_set_immediate enc4_3_door 1.00)
		(device_set_position enc4_3_door 1.00)
		(ai_place enc4_3/second_wave)
		(sleep -1 enc4_4_spawner)))

(script dormant void enc4_2_dialogue
	(begin
		(sleep 45) enc4_2_dialogue))

(script dormant void enc4_2
	(begin
		(sleep_until
			(volume_test_objects enc4_2
				(players)))
		(wake enc4_3)
		(wake enc4_2_dialogue)
		(if debug
			(print encounter 4.2...)) enc4_2
...
(script dormant void enc4_1_dialogue
	(begin
		(sleep 45) enc4_1_dialogue))

(script dormant void enc4_1
	(begin
		(wake enc4_2)
		(if debug
			(print encounter 4.1...)) enc4_1
		(wake enc4_1_dialogue) enc4_1 enc4_1))
...
(script dormant void enc3_9
	(begin
		(sleep_until
			(volume_test_objects_all grav_lift
				(players)))
		(ai_erase enc3_7_flood)
		(ai_erase enc3_7_cov)
		(if debug
...
(script dormant void enc3_8_dialogue
	(begin
		(sleep_until
			(objects_can_see_flag
				(players) waypoint2 45.00)) enc3_8_dialogue enc3_8_dialogue))

(script dormant void enc3_9_banshee_hook
	(begin enc3_9_banshee_hook))

(script continuous void enc3_8_lift_manager
	(begin
		(sleep 30)
		(if
			(volume_test_objects 1_to_2_transition_trigger
				(players))
			(set lift_counter
				(+ 1.00 lift_counter))
			(set lift_counter 0))))
...
(script dormant void enc3_8
	(begin
		...
		(sleep 30)
		(garbage_collect_now)
		(object_create_containing 2x_) enc3_8))

(script dormant void enc3_7
	(begin
		(sleep_until
			(volume_test_objects enc3_7
				(players))) enc3_7
		(if debug
			(print encounter 3.7...))
		(sound_looping_start levels\d20\music\d20_02 none 1.00)
		(wake enc3_8)
		(if
			(not coop)
			(begin
...
(script dormant void enc3_5_dialogue
	(begin
		(sleep_until
			(objects_can_see_flag
				(players) enc3_4_dialogue_trigger 20.00)) enc3_5_dialogue))
...
(script dormant void enc3_5
	(begin
		...
		(ai_vehicle_enterable_distance enc3_5_turret 10.00)
...
(script dormant void enc3_4
	(begin
		...
		(wake enc3_4_spawner)
		(sleep_until
			(volume_test_objects enc3_4b
				(players)) testing_fast)
		(set enc3_4_spawn_in_water false)
		(sleep_until
			(<=
				(ai_living_count enc3_4_cov/elites) 1))
		(sleep -1 enc3_4_spawner)))
...
(script dormant void enc3_3
	(begin
		...
		(if debug
			(print encounter 3.3...))
		(sleep_until
			(volume_test_objects enc3_3b
				(players)) testing_fast)
		(ai_place enc3_3/carriersb)
		(ai_place enc3_3/infsb)
		(object_create enc3_3_rifle)
		(sleep_until
			(volume_test_objects enc3_3c
				(players)) testing_fast)
		(ai_place enc3_3/carriersc)
		(ai_place enc3_3/infsc) enc3_3))

(script dormant void enc3_2_dialogue
	(begin
		(sleep_until
			(objects_can_see_flag
				(players) enc3_2_dialogue_trigger 30.00))
		(sleep 60) enc3_2_dialogue))
...
(script dormant void enc3_2
	(begin
		...
		(sleep_until
			(volume_test_objects enc3_2b
				(players)))
		(ai_place enc3_2_flood/f_the_player)
		(sleep_until
			(<=
				(ai_nonswarm_count enc3_1_flood) 0))
		(sleep -1 enc3_2_spawner)))
...
(script dormant void enc3_1_dialogue
	(begin
		(sleep 300) enc3_1_dialogue enc3_1_dialogue))
...
(script dormant void enc3_0
	(begin
		...
		(sleep_until
			(<=
				(ai_nonswarm_count enc3_0_flood) 1))
		...
		(if
			...
			(begin
				(sleep_until
					(<=
						(ai_living_count enc3_0_flood/combats) 1))
				(ai_place enc3_0_flood/combats)))))
...
(script continuous void enc1_1_exploration
	(begin
		(if
			(and
				(not enc1_1_door1)
				(volume_test_objects enc1_1_door1_volume
					(players)))
			(set enc1_1_door1 true))
		(if
			(and
				(not enc1_1_door2)
				(volume_test_objects enc1_1_door2_volume
					(players)))
			(set enc1_1_door2 true))
		(if
			(and
				(not enc1_1_door3)
				(volume_test_objects enc1_1_door3_volume
					(players)))
			(set enc1_1_door3 true))
		(if
			(and
				(not enc1_1_door4)
				(volume_test_objects enc1_1_door4_volume
					(players)))
			(set enc1_1_door4 true))
		(if
			(and enc1_1_doors enc1_1_door1 enc1_1_door2 enc1_1_door3 enc1_1_door4)
			(begin
				(set enc1_1_doors false) enc1_1_exploration))
		(if
			(not enc1_1_doors)
			(sleep -1))))
	...
	(begin
		(sleep_until
			(volume_test_objects enc1_5
				(players)))
		(set enc1_1_doors false) enc1_5
		(if debug
			(print encounter 1.5...))
		(sleep_until
			(>
				(device_get_position enc1_5_door) 0.80) testing_fast) enc1_5
		(sound_looping_set_alternate levels\d20\music\d20_01 true)
		(wake enc1_5_spawner)
		(ai_magically_see_players enc1_5_flood)
		(sleep_until
			(> enc1_5_limiter 8) 30 600) enc1_5
		(sleep_until
			(> enc1_5_limiter 15)) enc1_5 enc1_5
		(set cortana_told_you_to_jump true)
		(sleep_until
			(> enc1_5_limiter 20)) enc1_5
		(sleep_until
			(> enc1_5_limiter 26)) enc1_5))
...
(script dormant void enc1_1
	(begin
		...
		(if debug
			(print encounter 1.1...))
		(ai_place enc1_1) enc1_1
		(wake enc1_2) enc1_1 enc1_1
...
(script dormant void section1
	(begin
		...
		(sleep_until
			(volume_test_objects 0_to_1_transition_trigger
				(players)) testing_fast)
		(sleep -1 enc1_5)
...
(script dormant void intro_cutscene_aux
	(begin
		(sleep 60) intro_cutscene_aux
		(sleep 30) intro_cutscene_aux
		(sleep 240) intro_cutscene_aux))
...
(script startup void mission
	(begin
		(fade_out 0.00 0.00 0.00 0)
		(if debug
			(print initializing...)) mission mission mission mission mission
		(if mission
			(begin
		...
		(if
			(not cinematic_ran)
			(fade_in 0.00 0.00 0.00 0)) mission mission
		(garbage_collect_now)
		(wake save_checkpoints)
		(wake section1)
		(wake section4)
		(wake section5)
		(wake section6) mission))

(script dormant void oops
	(begin
		(sound_impulse_start sound\dialog\d20\d20_insert_052_cortana none 1.00)
		(print cortana: oh, i see! the coordinate data needs to be--)
		(sleep
			(sound_impulse_time sound\dialog\d20\d20_insert_052_cortana))
		(print cortana done)
		(sleep 30)
		(sound_impulse_start sound\dialog\d20\d20_insert_053_cortana none 1.00)
...
(script dormant void captain_music
	(begin
		(sleep 18)
		(sound_looping_start sound\sinomatixx_music\d20_captain_music none 1.00)))
...
(script dormant void fall_music
	(begin
		(sleep 30)
		(sound_looping_start sound\sinomatixx_music\d20_fall_music none 1.00)))
